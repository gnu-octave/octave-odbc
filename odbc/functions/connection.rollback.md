...
<dt class="deftypefn def-line" id="index-rollback"><span><strong class="def-name">rollback</strong> <code class="def-code-arguments">(<var class="var">conn</var>)</code></span></dt>
